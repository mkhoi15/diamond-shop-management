...
{
    [Authorize(Roles = $"{nameof(Roles.User)},{nameof(Roles.Manager)}")]
    public class DiamondDetailModel : PageModel
    {
        ...
        public DiamondDetailModel(IDiamondServices diamondServices, IPaperworkServices paperworkServices, IMediaServices mediaServices, IMapper mapper)
        {
